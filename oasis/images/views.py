...
from oasis.users import serializers as user_serializers
...
class Images(APIView):
    ...
    def post(self, request, format=None):
        ...
        serializer = serializers.InputImageSerializer(data=request.data, partial=True)
...
class Comment(APIView):
    def get(self, request, comment_id, format=None):
        ...
        try:
            ...
            serializer = serializers.CommentSerializer(found_comment)
            return Response(data=serializer.data, status=status.HTTP_200_OK)
